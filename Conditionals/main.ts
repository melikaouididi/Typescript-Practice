/*
    ...
    Description
    Create a TypeScript function that takes a number as input and returns a string 
    indicating whether the number is positive, negative, or zero.

    Requirements
    - Use appropriate types for the function parameter and return type.
    - Use an if-else statement to check the value of the input number and return the 
    corresponding string.

*/

function numberIdentifier(num: number): string {
